...
export default function Headline() {
  return (
    <div className="mt-36 text-center ">
        <h1 class="mb-4 text-3xl font-extrabold text-gray-900 justify-center items-center dark:text-black md:text-5xl lg:text-6xl"> All of financial knowledge <span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-700 from-sky-500">in one space.</span></h1>
